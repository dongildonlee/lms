% =================================================================
% KSAT English 2025 — Shared Passage + Q43–45 (Bundle)
% Standalone, copy-paste ready. Compile with XeTeX/Tectonic.
% =================================================================
...
\usepackage{enumitem}
\usepackage{fontspec}
\usepackage{xeCJK} % Korean text support
\usepackage[most]{tcolorbox}
\tcbuselibrary{breakable,raster}
\tcbset{colback=white,colframe=black!60,sharp corners,boxsep=4pt}

% ----- Fonts (robust fallbacks so it compiles even if Noto isn't installed)
\newcommand{\setupCJK}{%
...
% ----- Importer no-ops (safe for standalone compile)
\newenvironment{asset}[1]{}{}
\newcommand{\uses}[1]{}
\newcommand{\answer}[1]{} % <-- makes \answer harmless for LaTeX
...
\setcounter{enumi}{17} % so the next \item is 18
...
\end{enumerate} % <-- close 18–42

% ================================================================
% ========== Shared passage for Q43–Q45 (appears once) ==========
% ================================================================
\begin{asset}{passage-43-45}
  \begin{tcolorbox}[title=\large Reading Passage (shared for Q43–Q45),breakable]
    \begin{tcbraster}[raster columns=2,raster equal height=rows,raster column skip=8pt]
      % ---- (A)
      \begin{tcolorbox}[title=\large (A),breakable]
      ...
      \end{tcolorbox}
      % ---- (B)
      \begin{tcolorbox}[title=\large (B),breakable]
      ...
      \end{tcolorbox}
      % ---- (C)
      \begin{tcolorbox}[title=\large (C),breakable]
      ...
      \end{tcolorbox}
      % ---- (D)
      \begin{tcolorbox}[title=\large (D),breakable]
...
% ================================================================
% ========== Q43–45 (force MCQ + bundle sequencing) =============
% ================================================================
\begin{enumerate}[label=\textbf{\arabic*.},leftmargin=1.4em]
\setcounter{enumi}{42} % so the first item is 43

% --- Q43 --------------------------------------------------------
%% tags: [KSAT - English, KSAT - English 2025]
%% type: mcq
%% diag: ["bundle:KSAT-2025-43-45","bundle_index:1","reading:shared-passage"]
\item \uses{passage-43-45}
...
%% tags: [KSAT - English, KSAT - English 2025]
%% type: mcq
%% diag: ["bundle:KSAT-2025-43-45","bundle_index:2","reading:shared-passage"]
\item \uses{passage-43-45}
...
%% tags: [KSAT - English, KSAT - English 2025]
%% type: mcq
%% diag: ["bundle:KSAT-2025-43-45","bundle_index:3","reading:shared-passage"]
\item \uses{passage-43-45}
