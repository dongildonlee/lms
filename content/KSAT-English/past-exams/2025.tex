...
\begin{tikzpicture}
  \node[inner sep=0pt]
    {\includegraphics[width=13.2cm]{/opt/render/project/src/content/KSAT-English/past-exams/img/q27_graph.png}};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
  \node[inner sep=0pt]
    {\includegraphics[width=13.2cm]{/opt/render/project/src/content/KSAT-English/past-exams/img/q28_graph.png}};
\end{tikzpicture}
\end{center}
...
\begin{enumerate}
  \item 축제는 매년 열린다.
  \item 행사는 7일 동안 진행된다.
  \item 눈 조각 경연에는 11개 팀이 참가한다.
  \item 주차가 가능하다.
  \item 셔틀버스 요금은 편도 1달러이다.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item requires us to think all the time
\end{enumerate}
