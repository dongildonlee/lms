...
\begin{center}
\begin{tikzpicture}[x=1cm,y=1cm, every node/.style={align=left, inner sep=4pt}]
  \node[draw, rounded corners, text width=13.6cm, anchor=north west] at (0,0){%
