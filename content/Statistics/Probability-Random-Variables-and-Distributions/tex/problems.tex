% Statistics — Probability, Random Variables, and Distributions (RV, means and SD)
% Minimal TeX: no \documentclass or packages; just one top-level enumerate.
% Each item repeats the same table so every question is self-contained.
